  ...
  return (
    <div className="max-w-7xl mx-auto ">
      <Head>
       ...
       <div className="flex justify-between items-center bg-yellow-400 border-y border-black py-5 lg:py-0">
         ...
         <div className="px-10 space-y-5">
           ...
           <h2>It's easy and free  to post your thinking on any topic and connect with millions
             of readers.
           </h2>
         </div>
         ...
         {posts.map((post) => {
          ...
          return(<Link key={post._id} href={`/post/${post.slug.current}`}>
             ...
             <div className="flex justify-between p-5 bg-white">
               ...
               <img className="h-12 w-12 rounded-full m-1" src={urlFor(post.author.image).url()!}/>
             </div>
             </div>
           </Link>)
